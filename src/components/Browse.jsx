...
const Browse = () => {
  return (
    <section className='flex flex-col items-center justify-center gap-2 my-3 font-poppins' id='browse'>
        <h2 className='text-3xl text-center font-semibold'>Browse top categories</h2>
